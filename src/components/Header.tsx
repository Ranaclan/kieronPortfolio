    ...
    <header className={`bg-gray-900 text-white p-4 transition-all duration-300 ${isSticky ? 'fixed top-0 left-0 right-0 shadow-md z-50' : ''}`}>
      <nav className="container mx-auto flex justify-between items-center">
        ...
        <ul className="flex space-x-4">
          <li><a href="/kieronPortfolio/#about" className="hover:text-gray-300 transition-colors">About</a></li>
          ...
          <li><a href="src\cv\Kieron Rana CV.docx.pdf" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300 transition-colors">CV</a></li>
